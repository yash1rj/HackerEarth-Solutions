...
The book has a special ISBN(International Standard Book Number) which is  u
nique numeric book identifier only for Voldemort's book printed on it. 
...
isbn=int(input())
if (isbn<1000000000) and (isbn>9999999999):
    print("Illegal ISBN")
else:
    if(calc_sum(isbn)%11==0):
        print("Legal ISBN")
    else:
        print("Illegal ISBN")
